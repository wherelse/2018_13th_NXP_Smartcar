...
__M_PAGE(UI_MENU, "SmartCar", PAGE_NULL,
	{
		...
		SOLGUI_Widget_Spin(6, "stopflag", INT16, 0, 2, &stopflag);
		SOLGUI_Widget_Spin(7, "enCircle", INT16, 0, 1, &enCircle);
        SOLGUI_Widget_Spin(8, "StopEn", INT16, 0, 1, &stopen);
		SOLGUI_Widget_Spin(9, "ciclelow", INT16, 0, 1000, &ciclelow);
		SOLGUI_Widget_Spin(10, "ciclehigh", INT16, 0, 1000, &ciclehigh);
		SOLGUI_Widget_Spin(11, "Speed", FLT16, -100, 1000, &ExpectSpeed);
		SOLGUI_Widget_Spin(12, "SpeedADJ", INT16, -100, 100, &speed_adjust);
		SOLGUI_Widget_Spin(13, "SpeedOut", FLT16, 0, 2000, &SpeedOut);
		SOLGUI_Widget_Spin(14, "realSpeed", INT16, -1000, 1000, &g_real_speed);
		SOLGUI_Widget_Button(15, "flashsave", flash_savedata);
		SOLGUI_Widget_OptionText(16, "DirOut:%f", DirOut);
	});
