...
void lcd_cross(Site_t site, uint16 len, uint16 Color)
{
    ...
    if (!((site . x < ST7735S_get_w()) && (site . y < ST7735S_get_h()))) assert_failed("E:\\2018\351\243\236\345\215\241\\smart_car\\2018_13th_NXP_Smartcar\\Smartcar_\347\233\264\347\253\213\\Board\\src\\VCAN_LCD.c", 87);   
