...
extern uint16 ad_ave(ADCn_Ch_e adcn_ch, ADC_nbit bit, uint8 N); 
...
void _UI_MENU(){{ SOLGUI_Cursor(6,0,16); SOLGUI_Widget_GotoPage(0,&UI_Debug); SOLGUI_Widget_OptionText(1, "ADC0:%d" , adc_value[0]); SOLGUI_Widget_OptionText(2, "ADC1:%d" , adc_value[1]); SOLGUI_Widget_OptionText(3, "ADC2:%d" , adc_value[2]); SOLGUI_Widget_OptionText(4, "ADC3:%d" , adc_value[3]); SOLGUI_Widget_Spin(5, "run", 0x02, 0, 2, &flag_run); SOLGUI_Widget_Spin(6, "enCircle", 0x02, 0, 1, &enCircle); SOLGUI_Widget_Spin(7, "cicle_value", 0x02, -3000, 3000, &cicle_value); SOLGUI_Widget_Spin(8, "ciclelow", 0x02, 0, 1000, &ciclelow); SOLGUI_Widget_Spin(9, "ciclehigh", 0x02, 0, 1000, &ciclehigh); SOLGUI_Widget_Spin(10, "Speed", 0x04, -100, 1000, &ExpectSpeed); SOLGUI_Widget_Spin(11, "SpeedADJ", 0x02, -100, 100, &speed_adjust); SOLGUI_Widget_Spin(12, "SpeedOut", 0x04, 0, 2000, &SpeedOut); SOLGUI_Widget_Spin(13, "realSpeed", 0x02, -1000, 1000, &g_real_speed); SOLGUI_Widget_Button(14, "flashsave", flash_savedata); SOLGUI_Widget_OptionText(15, "DirOut:%f", DirOut); }} MENU_PAGE UI_MENU={"SmartCar",0,_UI_MENU};;


void _UI_Debug(){{ SOLGUI_Cursor(6,0,16); SOLGUI_Widget_Spin(0, "SKp", 0x04, -100, 100, &Speed_Kp); SOLGUI_Widget_Spin(1, "SKi", 0x04, -100, 100, &Speed_Ki); SOLGUI_Widget_Spin(2, "BKp", 0x04, -1000, 1000, &Balance_Kp); SOLGUI_Widget_Spin(3, "BKd", 0x04, -1000, 1000, &Balance_Kd); SOLGUI_Widget_Spin(4, "DKp", 0x04, -10000, 10000, &DirKp); SOLGUI_Widget_Spin(5, "DKd", 0x04, -10000, 10000, &DirKd); SOLGUI_Widget_Spin(6, "Speedmax", 0x02, -1000, 1000, &speedMax); }} MENU_PAGE UI_Debug={"Debug",&UI_MENU,_UI_Debug};;
