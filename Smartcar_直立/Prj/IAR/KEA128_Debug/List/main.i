...
void flash_saveinit(void)
{
	...
	data.sectornum_start = (256) - 9;     
	data.sectornum_end = (256) - 4;       

	data.data_addr = &mydata;                          
	data.data_size = sizeof(mydata);                  
...
void flash_savedata(void)
{
	...
	data.data_addr = &mydata;                          
	data.data_size = sizeof(mydata);                  
	(*(flash_data_save_t)((*((uint32_t *)((0x1A0) + (uint32)(&(((mydata_in_t *)0)->flash_data_save))) ))))(&data);
}
