...
float g_dirControl_P = 50;
float g_dirControl_D = 60;
...
void DirectionControl(void)
{
	...
	g_fDirectionError_dot = 1500 * (g_fDirectionErrorTemp[0] - g_fDirectionErrorTemp[3]);
	...
	g_fDirectionControlOut = g_fDirectionError * g_dirControl_P + g_fDirectionError_dot * (g_dirControl_D / 100.0);
...
void Read_ADC(void)
{
	...
	for (i = 0; i<5; i++)
	{
		ad_valu[0][i] = ad_ave(ADC0_SE15, ADC_12bit, 5);  			
		ad_valu[1][i] = ad_ave(ADC0_SE13, ADC_12bit, 5);     		
	}
