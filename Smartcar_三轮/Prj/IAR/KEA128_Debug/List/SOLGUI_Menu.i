...
void _UI_MENU(){{ SOLGUI_Cursor(6, 0, 12); SOLGUI_Widget_OptionText(0, "keynum:%d", KEY_NUM); SOLGUI_Widget_GotoPage(1, &EDIT); SOLGUI_Widget_OptionText(2, "lossline:%d", loss_line); SOLGUI_Widget_OptionText(3, "ADC0:%d", adc_value[0]); SOLGUI_Widget_OptionText(4, "ADC1:%d", adc_value[1]); SOLGUI_Widget_OptionText(5, "ADC2:%d", adc_value[2]); SOLGUI_Widget_OptionText(6, "ADC3:%d", adc_value[3]); SOLGUI_Widget_OptionText(7, "realspeed=%d", g_real_speed); SOLGUI_Widget_OptionText(8, "dir.err=%d", adc_value[3] - adc_value[0]); SOLGUI_Widget_OptionText(9, "position=%d", position); SOLGUI_Widget_OptionText(10, "SpeedL=%d", motorEncorderL); SOLGUI_Widget_OptionText(11, "SpeedR=%d", motorEncorderR); }} MENU_PAGE UI_MENU={"SmartCar",0,_UI_MENU};;

void _EDIT(){{ SOLGUI_Cursor(6, 0, 10); SOLGUI_Widget_Spin(0,"baseSpeed",0x03,200,0,&g_base_speed); SOLGUI_Widget_Spin(1,"SetSpeed",0x03,200,0,&g_set_speed); SOLGUI_Widget_Spin(2, "losespeed", 0x03, 1000, 0,&loselinespeed); SOLGUI_Widget_Spin(3, "spKp", 0x04, 100, 0, &speed . Kp); SOLGUI_Widget_Spin(4, "spKd", 0x04, 100, 0, &speed . Ki); SOLGUI_Widget_Spin(5,"dirKp",0x04,100,-100,&dir . Kp); SOLGUI_Widget_Spin(6,"dirKd",0x04,100,-100,&dir . Kd); SOLGUI_Widget_Spin(7,"DutyMax",0x03,1000,0,&dutyMax); SOLGUI_Widget_Spin(8,"leftThr",0x03,1000,0,&left_lossline_Range); SOLGUI_Widget_Spin(9,"rightthr",0x03,1000,0,&right_lossline_Range); SOLGUI_Widget_GotoPage(10,&UI_MENU); }} MENU_PAGE EDIT={"Edit",&UI_MENU,_EDIT};;
