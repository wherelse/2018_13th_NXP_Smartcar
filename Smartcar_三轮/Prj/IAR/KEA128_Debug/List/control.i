...
void Motor_control(void)
{
	...
	{
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH0, 0.4*(-dutyL));
	...
	else if (dutyR < 0)
	{
		...
		ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH3, 0.4*(-dutyR));
	}
        else
        {
        ftm_pwm_duty(((FTM_Type *)(0x4003A000u)), FTM_CH2, 0);
...
void lose_line_deal(int *adc_Value, int position, int leftRange, int rightRange)
{
	...
	if (((leftRange > sensor_value_all) || (rightRange > sensor_value_all) )&& (adc_value[0]<10|| adc_value[3]<10))
	{
